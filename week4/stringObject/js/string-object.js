...
msg += '<h2>character index: 8-14</h2><p>' + saying.substring(8, 15) + '</p>';
 
// Find the first instance of 'me' in the string and replace it with a 'w' character and add it to the msg variable
msg += '<h2>replace</h2><p>' + saying
.toLowerCase()//can call a method this way
.replace('h', 'gn') + '</p>';//structure for debugging
